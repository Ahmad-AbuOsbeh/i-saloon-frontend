...
export const Names = ({ formData, setForm, navigation, steps, cancel, imageFile, setImageFile }) => {
  ...
  return (
    <Container className={`${classes.container} ${classes.textInputs}`} maxWidth='xs'>
      ...
      <FormControl variant='outlined' fullWidth margin='normal'>
        ...
        >
          <MenuItem className={classes.textInputs} value='male'>
            Male
          </MenuItem>
          <MenuItem className={classes.textInputs} value='female'>
            Female
          </MenuItem>
        </Select>
      </FormControl>
        ...
        <TextField
          ...
          onChange={(e) => {
            ...
            setForm({
              target: {
                name: 'profile_pic', // form element
                value: e.target.files[0], // the data/url
              },
            });
          }}
          name='profile_pic'
      ...
      <Button variant='contained' fullWidth className={classes.nextButton} onClick={(e) => validate(e)}>
        Next
      </Button>
