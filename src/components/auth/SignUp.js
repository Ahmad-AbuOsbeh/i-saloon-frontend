...
import { Radio, RadioGroup, FormControlLabel, FormControl, Grid, FormLabel, Button, Container } from '@material-ui/core';
        ...
        <Then>
          <form onSubmit={handleSubmit}>
            <FormControl fullWidth margin='normal' component='fieldset'>
              <FormLabel style={{ color: '#fff', fontSize: 24, textAlign: 'center', marginBottom: '2rem' }} component='legend'>
                user type
              </FormLabel>
              <RadioGroup aria-label='User Type' name='userType' value={userType} style={{ color: 'white' }} onChange={(e) => setUserType(e.target.value)}>
